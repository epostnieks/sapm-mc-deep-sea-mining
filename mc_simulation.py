#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Deep-Sea Mining / Abyssal Recovery Floor
========================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Deep-Sea Mining (Abyssal Recovery Floor).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "deep_sea_mining",
    "domain_name": "Deep-Sea Mining",
    "theorem": "Abyssal Recovery Floor",
    "classification": "Class 1 \u2014 Impossibility",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 5.0,
    "channels": {
        "C1_environmental_damage": {
            ...
            "high": 22.4,
            "weight": 0.35,
            "description": "$8.5B/yr; 10^6-yr nodule regen, DISCOL 26yr no recovery"
        },
        "C2_health_externality": {
            ...
            "high": 14.0,
            "weight": 0.25,
            "description": "3-4x spatial multiplier; plume smothers benthic filter-feeders"
        },
        "C3_climate_cost": {
            "dist": "normal",
            "low": 5.4,
            ...
            "high": 8.2,
            "weight": 0.2,
            "description": "Dewatering discharge at 1000-1500m disrupts twilight zone"
        },
        "C4_ecosystem_degradation": {
            ...
            "high": 5.6,
            "weight": 0.1,
            "description": "56% lower carbon throughput 26yr post-disturbance (DISCOL)"
        },
        "C5_governance_capture": {
            ...
            "high": 2.8,
            "weight": 0.1,
            "description": "90% CCZ megafauna undescribed; No Net Loss impossible"
        }
    },
